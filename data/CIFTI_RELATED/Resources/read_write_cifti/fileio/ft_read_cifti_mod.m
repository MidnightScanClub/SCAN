...
if readdata
  ...
  switch hdr.datatype
    ...
    case 256, [voxdata, nitemsread] = fread(fid, inf, 'int8');  assert(nitemsread==prod(hdr.dim(2:end)), 'could not read all data');
...
source.data = (source.data .* source.hdr.scl_slope) - source.hdr.scl_inter;
