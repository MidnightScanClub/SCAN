...
% pallete. With the 'default' option, any values that are outside
% 1 and 17 will be set to "Unknown" and colored gray; any values that are
% non-integers between 1 and 17 will be set to "Unknown" and given a color
% appropriate for the power_surfa pallete.
%
%E. Gordon 07/10/16
